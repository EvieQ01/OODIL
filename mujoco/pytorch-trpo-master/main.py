...
parser.add_argument('--env-name', default="CustomWalker2d-v0", metavar='G',
...
for i_episode in trange(900):
    ...
    if best_reward < reward_batch:
        best_reward = reward_batch
        print('best reward', ' ', reward_batch)
        
        torch.save(policy_net.state_dict(), save_path)
        torch.save(running_state, "../checkpoints/running_state_{}".format(args.xml))
